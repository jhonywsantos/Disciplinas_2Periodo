'''Escreva um programa que receba vários valores da taxa de glicose de Genival, até que o valor
informado seja 0, e calcule a glicose média observada naquele dia.Caso esse valor seja inferior a 110, 
o programa deve exibir a mensagem "Glicose Normal". Caso seja 200 ou mais, a mensagem exibida deve ser 
“Glicose Muito Alta". Nos demais casos, o programa deve exibir “Glicose Alterada”.'''
